...
var file_proto_file_proto_rawDesc = []byte{
	...
	0x0c, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a,
	...
	0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x07, 0x44,
	0x6f, 0x77, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x15, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x44, 0x6f,
...
var file_proto_file_proto_depIdxs = []int32{
	...
	6, // 3: file.FilesService.UploadAndNotifyProgress:input_type -> file.UploadAndNotifyProgressRequest
	1, // 4: file.FilesService.ListFiles:output_type -> file.ListFilesResponse
	3, // 5: file.FilesService.Dowload:output_type -> file.DownloadResponse
	5, // 6: file.FilesService.Upload:output_type -> file.UploadResponse
	7, // 7: file.FilesService.UploadAndNotifyProgress:output_type -> file.UploadAndNotifyProgressResponse
